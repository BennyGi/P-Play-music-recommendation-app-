...
const YearSelection = ({ onContinue, onSkip, onBack }) => {
   ...
   const getDecadeDescription = () => {
      ...
      if (selectedYears.from < 1950) {
         return "Vintage classics & jazz era";
      } else if (fromDecade === toDecade) {
         return `${fromDecade}s music`;
      } else if (selectedYears.to === currentYear && selectedYears.from <= 2000) {
         return "Classic to modern hits";
      } else if (selectedYears.from >= 2020) {
         return "Latest releases";
      } else if (selectedYears.from >= 2010) {
         return "Modern era";
      } else if (selectedYears.from >= 2000) {
         return "2000s to present";
      } else {
         ...
         <div className="max-w-5xl mx-auto py-12">
            ...
            <div className="text-center mb-12 space-y-4">
               ...
               <h2 className="text-5xl font-bold text-white">
                  What era of music do you prefer?
               </h2>
               <p className="text-xl text-white/80">
                  Select your preferred year range
               </p>

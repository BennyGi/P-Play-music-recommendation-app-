...
const RegistrationScreen = ({ onComplete }) => {
   ...
   const validateForm = () => {
      ...
      if (!userData.birthDate) {
         ...
         minAllowedDate.setFullYear(now.getFullYear() - 120); // הגבלה ל-120 שנה אחורה
               ...
               <div className="space-y-4">
                  <div>
                     ...
                     <input
                        ...
                        className={`w-full px-4 py-3 rounded-xl bg-white/20 text-white placeholder-white/50 border ${errors.firstName ? 'border-red-500' : 'border-white/30'} focus:border-pink-500 focus:outline-none focus:ring-2 focus:ring-pink-500/50`}
                        placeholder="John"
                     />
                  ...
                  <div>
                     ...
                     <input
                        ...
                        className={`w-full px-4 py-3 rounded-xl bg-white/20 text-white placeholder-white/50 border ${errors.lastName ? 'border-red-500' : 'border-white/30'} focus:border-pink-500 focus:outline-none focus:ring-2 focus:ring-pink-500/50`}
                        placeholder="Doe"
                     />
                  ...
                  <div>
                     ...
                     <input
                        ...
                        className={`w-full px-4 py-3 rounded-xl bg-white/20 text-white placeholder-white/50 border ${errors.email ? 'border-red-500' : 'border-white/30'} focus:border-pink-500 focus:outline-none focus:ring-2 focus:ring-pink-500/50`}
                  ...
                  <div>
                     ...
                     <div className="relative">
                        <input
                           ...
                           className={`w-full px-4 py-3 rounded-xl bg-white/20 text-white placeholder-white/50 border ${errors.password ? 'border-red-500' : 'border-white/30'} focus:border-pink-500 focus:outline-none focus:ring-2 focus:ring-pink-500/50 pr-12`}
                  ...
                  <div>
                     ...
                     <input
                        ...
                        className={`w-full px-4 py-3 rounded-xl bg-white/20 text-white placeholder-white/50 border ${errors.birthDate ? 'border-red-500' : 'border-white/30'} focus:border-pink-500 focus:outline-none focus:ring-2 focus:ring-pink-500/50`}
                     />
                  ...
                  <div className="relative" ref={dropdownRef}>
                     ...
                     <button
                        ...
                        className={`w-full px-4 py-3 rounded-xl bg-white/20 text-white text-left border flex items-center justify-between ${errors.country ? 'border-red-500' : 'border-white/30'} focus:border-pink-500 focus:outline-none focus:ring-2 focus:ring-pink-500/50`}
                     >
                        {selectedCountry ? (

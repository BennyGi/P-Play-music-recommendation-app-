...
import { Music, ArrowRight, User, Mail, Calendar, MapPin, Lock, Eye, EyeOff, ChevronDown, ArrowLeft } from 'lucide-react';
...
const RegistrationScreen = ({ onComplete, onBack }) => {
   ...
   const passwordStrength = useMemo(() => {
      if (!userData.password) return { strength: 0, label: '', color: 'bg-gray-500' };
      ...
      if (score === 100) return { strength: 100, label: 'Strong 💪', color: 'bg-green-500' };
               ...
               <div>
                  ...
                  <div className="relative">
                     <input
                        ...
                        className={`w-full px-4 py-3 pr-12 rounded-xl bg-white/20 text-white placeholder-white/50 border ${errors.password ? 'border-red-500' : 'border-white/30'
                           } focus:border-pink-500 focus:outline-none focus:ring-2 focus:ring-pink-500/50`}
